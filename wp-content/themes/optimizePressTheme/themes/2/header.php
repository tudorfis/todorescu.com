	...
	if ($header_prefs['menu_position']=='alongside'){
		...
		<style>
			...
			body #nav-side.navigation ul#navigation-alongside li a{ /* Alongside Navigation Link */
				color: <?php echo $header_prefs['alongside_nav_link']?>;
				font-family: <?php echo $header_prefs['alongside_nav_font_family']?>;
				font-size: <?php echo $header_prefs['alongside_nav_font_size']?>px;
				<?php echo $nav_shadow?>
				<?php echo $nav_weight?>
			}
			...
			if ($header_prefs['below_nav_link'] || $header_prefs['below_nav_font_family'] || $header_prefs['below_nav_font_size'] || $nav_shadow || $nav_weight):
				...
				echo 'body #nav-bottom.navigation ul#navigation-below li a{';
					...
					if ($header_prefs['below_nav_font_family']) {
					 echo 'font-family:' . $header_prefs['below_nav_font_family'] . ';';
					}
