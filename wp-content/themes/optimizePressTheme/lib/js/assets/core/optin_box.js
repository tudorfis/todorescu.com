...
div.field-id-op_assets_core_optin_box_tabs_content_paragraph',
                        ...
                        form_html: {
                            ...
                            fields: {
                                ...
                                list: {
                                    title: 'provider_list',
                                    type: 'select',
                                    showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['mailchimp', 'aweber', 'infusionsoft', 'icontact', 'getresponse', 'campaignmonitor', 'officeautopilot', 'ontraport']},
                                    events: {
                                        change: function(e) {
                                            /*
                                ...
                                thank_you_page: {
                                    ...
                                    showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['mailchimp', 'aweber', 'icontact', 'getresponse', 'campaignmonitor', 'officeautopilot', 'ontraport']}
                                },
                                action_page: {
                                    type: 'hidden',
                                ...
                                disable_name: {
                                    ...
                                    showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['email', 'custom', 'oneshoppingcart', 'mailchimp', 'aweber', 'infusionsoft', 'icontact', 'getresponse', 'campaignmonitor', 'officeautopilot', 'ontraport']}
                                },
                                name: {
                                    title: 'name',
                                    type: 'select',
                                ...
                                extra_fields: {
                                    ...
                                    showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['custom', 'oneshoppingcart', 'mailchimp', 'aweber', 'infusionsoft', 'icontact', 'getresponse', 'campaignmonitor', 'officeautopilot', 'ontraport']}
                                },
                                no_extras: {
                                    type: 'paragraph',
        ...
        customInsert: function(attrs){
            ...
            $.each(elems,function(i,v){
                if(v !== null){
                    var val = (v=='paragraph' ? ($.base64.encode(unescape(encodeURIComponent( attrs.content[v] ))) || '') : (attrs.content[v] || ''));
            ...
            $.each(val,function(i,v){
                ...
                if(v.attrs.name == 'paragraph'){
                    ...
                    if (typeof content != 'undefined') {
                        try {
                            OP_AB.set_wysiwyg_content(idprefix+'content_paragraph', decodeURIComponent(escape($.base64.decode(content))));
                        } catch(e) {
