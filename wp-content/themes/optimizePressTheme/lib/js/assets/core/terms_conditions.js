;var op_asset_settings = (function($){
	return {
		...
		customInsert: function(attrs){
			var str = '[terms_conditions style="'+attrs.style+'" accept_text="'+attrs.accept_text.replace(/"/ig,"'")+'"] [terms]'+attrs.terms+'[/terms] '+attrs.content+' [/terms_conditions]';
		...
		customSettings: function(attrs,steps){
			...
			$('#op_assets_core_terms_conditions_accept_text').val(attrs.attrs.accept_text || '');
			$('#op_assets_core_terms_conditions_content').val(attrs.content || '');
		}
	};
}(opjq));