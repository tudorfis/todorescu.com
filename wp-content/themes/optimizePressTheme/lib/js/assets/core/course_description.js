	...
	return {
		...
		customInsert: function(attrs){
			var str = '',
				...
				content = ($.base64.encode(unescape(encodeURIComponent(OP_AB.autop(attrs.content)))) || ''),
				font_str = '';
		...
		customSettings: function(attrs,steps){
			...
			OP_AB.set_wysiwyg_content('op_assets_core_course_description_content', decodeURIComponent(escape($.base64.decode(content))));
